...
const exerciseSeeds = (token) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const allMuscleGroups = yield muscle_group_api_1.muscleGroupApi.getAllMusclegroups(token);
    // Get id muscleGroup
    ...
    const espaldaMuscleGroupIdVal = (_d = allMuscleGroups.find(group => group.name === 'espalda')) === null || _d === void 0 ? void 0 : _d.id;
