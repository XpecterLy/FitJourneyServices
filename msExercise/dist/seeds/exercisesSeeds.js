...
const exerciseSeeds = (token) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const [allMuscleGroups, allTrainingStyle] = yield Promise.all([
        muscle_group_api_1.muscleGroupApi.getAllMusclegroups(token),
        training_styles_api_1.trainingStyleApi.getallTrainingStyles(token)
    ]);
    // Get id muscleGroup
    const pechoMuscleGroupIdVal = (_a = allMuscleGroups.find(group => group.name === 'pecho')) === null || _a === void 0 ? void 0 : _a.id;
    const tricepsMuscleGroupIdVal = (_b = allMuscleGroups.find(group => group.name === 'tríceps')) === null || _b === void 0 ? void 0 : _b.id;
    const bicepsMuscleGroupIdVal = (_c = allMuscleGroups.find(group => group.name === 'biceps')) === null || _c === void 0 ? void 0 : _c.id;
    const backMuscleGroupIdVal = (_d = allMuscleGroups.find(group => group.name === 'espalda')) === null || _d === void 0 ? void 0 : _d.id;
    const legMuscleGroupIdVal = (_e = allMuscleGroups.find(group => group.name === 'pierna')) === null || _e === void 0 ? void 0 : _e.id;
    const deltoideMuscleGroupIdVal = (_f = allMuscleGroups.find(group => group.name === 'deltoide')) === null || _f === void 0 ? void 0 : _f.id;
    // get id trainingStyleId
    const cardioIdVal = (_g = allTrainingStyle.find(item => item.name = 'cardio')) === null || _g === void 0 ? void 0 : _g.id;
    const hypertrophyTrainingStyleIdVal = (_h = allTrainingStyle.find(item => item.name = 'Hypertrophy Training')) === null || _h === void 0 ? void 0 : _h.id;
...
exports.exerciseSeeds = exerciseSeeds;
