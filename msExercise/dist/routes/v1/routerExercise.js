...
routersExercise.post('/add_seed', authMiddleware_1.checkAuth, authMiddleware_1.verifyToken, (0, authMiddleware_1.checkRolAuth)(['admin']), exerciseController_1.AddExercisesSeed);
