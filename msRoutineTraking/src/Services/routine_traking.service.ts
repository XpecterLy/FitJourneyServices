...
export const getAllRoutinesTrakingService = async (userId: string): Promise<response_routine_trakin_type[]> => {
    const res = await routineTrakingModel.find({ userId: userId });
