...
exports.completeRoutineTrakingByIsActiveService = exports.deleteRoutineTrakingByIdService = exports.updateRoutineTrakingByIdService = exports.InsertRoutineTrakingServise = exports.getRoutineTrakingByIdService = exports.getAllRoutinesTrakingService = void 0;
const routine_traking_schema_1 = require("../schemas/routine_traking.schema");
const getAllRoutinesTrakingService = (limit, offset, userId, routineId, state) => __awaiter(void 0, void 0, void 0, function* () {
    const query = { userId };
    if (routineId)
...
const completeRoutineTrakingByIsActiveService = (idUser) => __awaiter(void 0, void 0, void 0, function* () {
    yield routine_traking_schema_1.routineTrakingModel.updateMany({ userId: idUser, state: 'active' }, { state: 'completed' });
});
exports.completeRoutineTrakingByIsActiveService = completeRoutineTrakingByIsActiveService;
