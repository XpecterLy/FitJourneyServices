...
const routineTrakingExercise_1 = require("../api/routineTrakingExercise");
...
const insertRoutineTraking = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const routineData = yield routine_api_1.routineApi.getRoutineById(data.routineId, req.token);
        data.state = data.state != undefined ? data.state : 'create';
        data.dateCreate = (0, dateUntil_1.getCurrentDate)();
        const resInsert = yield (0, routine_traking_service_1.InsertRoutineTrakingServise)(Object.assign(Object.assign({}, data), { userId: userId }));
        yield Promise.all(routineData.exercises.map(item => routineTrakingExercise_1.routineTrakingExerciseApi.insertRoutineTrakingExercise(req.token, {
            exerciseId: item,
...
const updateRoutineTraking = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (data.state == 'active')
            yield (0, routine_traking_service_1.completeRoutineTrakingByIsActiveService)(req.userId);
