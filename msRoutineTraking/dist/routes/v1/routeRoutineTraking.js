...
exports.routerRoutineTraking.get('/all', authMiddleware_1.checkAuth, authMiddleware_1.verifyToken, (0, authMiddleware_1.checkRolAuth)(['admin', 'user']), (0, schemaValidator_1.default)("/routineTraking/filter", true, "query"), routineTrakingController_1.getAllRoutinesTraking);
