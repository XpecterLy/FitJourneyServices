...
const GetAllCategoriesMuscleGroupService = (trainingStylesId, limit) => __awaiter(void 0, void 0, void 0, function* () {
    var filter = {};
    trainingStylesId != undefined ?
        filter = Object.assign(Object.assign({}, filter), { trainingStylesId: trainingStylesId }) :
        filter;
    const res = yield CategoriesMuscleGroup_schema_1.categoriesMuscleGroupModel.find(filter).limit(limit || 10);
