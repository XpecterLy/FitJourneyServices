...
const GetAllCategoriesTrainingStylesService = (limit) => __awaiter(void 0, void 0, void 0, function* () {
    const res = yield CategoriesTrainingStyles_schema_1.categoriesTrainingStylesModel.find().limit(limit || 10);
